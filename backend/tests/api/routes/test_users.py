...
def test_get_users_superuser_me(
    ...
    r = client.get(f"{app_settings.API_V1_STR}/users/me", headers=superuser_token_headers)
    current_user = r.json()
    assert current_user
...
def test_get_users_normal_user_me(
    ...
    r = client.get(f"{app_settings.API_V1_STR}/users/me", headers=normal_user_token_headers)
    current_user = r.json()
    assert current_user
    assert current_user["is_active"] is True
...
def test_create_user_new_email(
    ...
    with (
        ...
        r = client.post(
            f"{app_settings.API_V1_STR}/users/",
...
def test_get_existing_user(
    ...
    user_id = user.id
    r = client.get(
        f"{app_settings.API_V1_STR}/users/{user_id}",
        headers=superuser_token_headers,
    )
    assert 200 <= r.status_code < 300
    api_user = r.json()
...
def test_get_existing_user_permissions_error(
    ...
    r = client.get(
        f"{app_settings.API_V1_STR}/users/{uuid.uuid4()}",
...
def test_retrieve_users(
    ...
    r = client.get(f"{app_settings.API_V1_STR}/users/", headers=superuser_token_headers)
    all_users = r.json()
...
def test_update_user_me(
    ...
    r = client.patch(
        f"{app_settings.API_V1_STR}/users/me",
        headers=normal_user_token_headers,
        json=data,
    )
...
def test_register_user(client: TestClient, db: Session) -> None:
    ...
    r = client.post(
        f"{app_settings.API_V1_STR}/users/signup",
        json=data,
    )
    assert r.status_code == 200
    created_user = r.json()
...
def test_update_user(
    ...
    r = client.patch(
        f"{app_settings.API_V1_STR}/users/{user.id}",
        headers=superuser_token_headers,
        json=data,
    )
    assert r.status_code == 200
