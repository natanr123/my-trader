...
export class OrdersService {
     ...
     * @throws ApiError
     */
    public static listOrders(): CancelablePromise<OrdersListOrdersResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/orders/'
        });
     ...
     * @throws ApiError
     */
    public static syncOrders(): CancelablePromise<OrdersSyncOrdersResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static hello(): CancelablePromise<OrdersHelloResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/orders/hello'
        });
    }
}
